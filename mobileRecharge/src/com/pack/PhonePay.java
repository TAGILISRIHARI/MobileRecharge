...
public class PhonePay 
{
	...
	public void beginPhonePayTransaction(int variableCount) throws Exception
	{
		if(variableCount<3)
		{
			System.out.println("\t--------------------------------------------------------------------------------------------\n");
			System.out.println("\t\t\t\t======>  Wellcome to PhonePay  <======\n");
			Variables variableObjectPhonePay= new Variables();
			while(true)
			 {
				 ...
				 try
				 {
					 ...
					 variableObjectPhonePay.setUpiNumber(sc.nextLong());
					break; 
				 }
				 catch(Exception e)
				 {
...
//					 System.out.println("\t"+e.toString());
			 ...
			 long upiNumber=variableObjectPhonePay.getUpiNumber();
			 
			 int count = VerifyMobileORUPINumber.countMobileNumber(upiNumber);
			 boolean firstNumber = getFirstNumber();
			 ...
			 else
			 {
				 ...
				 beginPhonePayTransaction(variableCount);
			 }
	...
	public void confirmPhonePay() throws Exception
	{
		System.out.println("\t-------------------------------------------------------");
