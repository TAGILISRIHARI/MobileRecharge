...
public class BSNL 
{
	public void getRechargePacksBSNL() throws Exception
	{
		System.out.println("\t--------------------------------------------------------------------------------------------\n");
		System.out.println("\t\t\t\t======>  BSNL Recharge Plans  <======\n");

		System.out.println("\t---------------------------------------------------------------------------------------------");
		System.out.println("\n\tSelect Your Pack  \n"
				+ "\t1.  BEST SELLING PACKS\n"
				+ "\t2.  DATA PACKS\n"
				+ "\t3.  SPECIAL RECHARGE\n"
				+ "\t4.  FULL TAIKTIME\n"
				+ "\t5.  TOP UP\n"
...
//				DATA PACKS
			...
			case 3:
//				SPECIAL RECHARGE
				specialRechargePacksBSNL();
				break;
			case 4:
//				FULL TAIKTIME
				fullTalktimePacksBSNL();
				break;
			case 5:
//				TOP UP
				topUpPacksBSNL();
...
//				Calling same method
				...
				getRechargePacksBSNL();
		}
	}
//	BEST SELLING PACKS
	public void bestSellingPacksBSNL() throws Exception
	{
		System.out.println("\t--------------------------------------------------------------------------------------------\n");
		System.out.println("\t\t\t\t======>  BEST SELLING PACKS  <======\n");
...
//	DATA PACKS
	public void dataPacksBSNL() throws Exception
	{
		System.out.println("\t--------------------------------------------------------------------------------------------\n");
...
//	SPECIAL RECHARGE
	public void specialRechargePacksBSNL( ) throws Exception
	{
		System.out.println("\t--------------------------------------------------------------------------------------------\n");
		...
		System.out.println("\t₹199		Data:			Validity:\n"
				...
				+ "\tUnlimited voice calls(Local/STD) any-net in Home LSA and national roaming including MTNL network \n"
				+ "\tin Mumbai and Delhi + Unlimited data with speed reduced to 40Kbps after 2GB/day + 100 SMS/day to \n"
				+ "\tAny N/w Including while Roaming in Mumbai and New Delhi.Charges after freebies are as follows:\n"
				+ "\tVoice call charges: Local calls Rs 1/min, STD calls Rs 1.3/ min Video Calls : Local/STD:- Rs 2/min\n"
				+ "\t SMS: Local 80p/SMS, National: Rs 1.20/SMS International: Rs 5/SMS Data Charges 25p/MB");
		System.out.println("\t--------------------------------------------------------------------------------------------");
...
//	FULL TAIKTIME
	public void fullTalktimePacksBSNL() throws Exception
	{
		System.out.println("\t--------------------------------------------------------------------------------------------\n");
		System.out.println("\t\t\t\t======>  FULL TAIKTIME  <======\n");
...
//	TOP UP
	public void topUpPacksBSNL() throws Exception
	{
		System.out.println("\t--------------------------------------------------------------------------------------------\n");
...
//	2G DATA
	public void data2GPacksBSNL() throws Exception
	{
		System.out.println("\t--------------------------------------------------------------------------------------------\n");
...
//	ROAMING
	public void roamingPacksBSNL() throws Exception
	{
		System.out.println("\t--------------------------------------------------------------------------------------------\n");
