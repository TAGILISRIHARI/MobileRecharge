...
public class Paytm 
{
	...
	public void beginPaytmTransaction(int variableCount) throws Exception
	{
		if(variableCount<3)
		{
			System.out.println("\t--------------------------------------------------------------------------------------------\n");
			System.out.println("\t\t\t\t======>  Wellcome to Patym  <======\n");

			Variables variableObjectPaytm = new Variables();
			while(true)
			 {
				 try
				 {
					 ...
					 variableObjectPaytm.setUpiNumber(sc.nextLong());
					break; 
				 }
				 catch(Exception e)
				 {
...
//					 System.out.println("\t"+e.toString());
			 ...
			 long upiNumber=variableObjectPaytm.getUpiNumber();
			 ...
			 else
			 {
				 ...
				 beginPaytmTransaction(variableCount);
			 }
		}
		else
		{
	...
	public void confirmPaytm() throws Exception
	{
		System.out.println("\t-------------------------------------------------------");
