...
public class UPIViewOnlyPaytm 
{
	public void getingPaytmPayments() throws Exception
	{
			try
			{
				//Loading Server
				...
				//Executing query
				ResultSet rs = stm.executeQuery("select  * from upiDetails where upiplatform='Paytm'");
