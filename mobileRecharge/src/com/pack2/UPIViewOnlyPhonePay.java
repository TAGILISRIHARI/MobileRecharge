...
public class UPIViewOnlyPhonePay 
{
	public void getingPhonePayPayments() throws Exception
	{
			try
			{
				//Loading Server
				...
				//Executing query
				ResultSet rs = stm.executeQuery("select  * from upiDetails where upiplatform='PhonePay'");
