...
public class CardViewOnlyDebitCard 
{
	public void getingDebitCardPayments() throws Exception
	{
		try
		{
			//Loading Server
			...
			//Executing query
			ResultSet rs = stm.executeQuery("select  * from cardDetails where CARDNAME='Debit'");
